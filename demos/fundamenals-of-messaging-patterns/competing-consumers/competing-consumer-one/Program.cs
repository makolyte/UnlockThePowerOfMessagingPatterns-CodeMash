...
{
	Console.WriteLine();
	Console.WriteLine($"Consumer 1 processing message: {args.Message.Body}");
	await Task.Delay(new Random().Next(200, 1500)); // Simulate variable processing time
	await args.CompleteMessageAsync(args.Message);
	Console.WriteLine($"Consumer 1 completed message: {args.Message.Body}");
};
...
Console.WriteLine("Console 1 is ready to process messages; press any key to stop processing...");
