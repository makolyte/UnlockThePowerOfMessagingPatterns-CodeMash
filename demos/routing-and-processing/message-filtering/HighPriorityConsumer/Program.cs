...
const string subscriptionName = "HighPriority";
...
{
	Console.WriteLine($"Received high-priority message: {args.Message.Body}");
...
Console.WriteLine("Waiting for high-priority messages, press any key to end processing...");
Console.ReadKey();
