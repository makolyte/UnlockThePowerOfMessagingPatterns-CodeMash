...
const string queueName = "transactional-queues.participant-2";
...
Console.WriteLine("Transactional Participant 2 is listening for messages. Press any key to stop receiving messages...");
